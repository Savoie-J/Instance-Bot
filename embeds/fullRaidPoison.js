...
const combinabilityRules = {
  "Base": ["learner", "Base (Yaka)", "CPR", "Poison Tanks", "North Tank", "Jelly Wrangler", "Main Stun", "Stun 5", "Shark 10"],
  "Backup": ["learner", "Base (Yaka)", "CPR", "Poison Tanks", "North Tank", "Jelly Wrangler", "Main Stun", "Stun 5", "Shark 10"],
  "North Chargers": ["learner", "Base (Yaka)", "CPR", "Poison Tanks", "North Tank", "Jelly Wrangler", "Main Stun", "Stun 5", "Shark 10"],
  "Pet 1/3": ["learner", "Base (Yaka)", "CPR", "Poison Tanks", "North Tank", "Jelly Wrangler", "Main Stun", "Stun 5", "Shark 10"],
  "Pet 2": ["learner", "Base (Yaka)", "CPR", "Poison Tanks", "North Tank", "Jelly Wrangler", "Main Stun", "Stun 5", "Shark 10"],
  "Free": ["learner", "backup", "North Chargers", "Pet 1/3", "Pet 2", "Base (Yaka)", "CPR", "Poison Tanks", "North Tank", "Jelly Wrangler", "Main Stun", "Stun 5", "Shark 10"],
  ...
  "Poison Tanks": ["base", "backup", "North Chargers", "Pet 1/3", "Pet 2", "learner", "North Tank", "Jelly Wrangler", "Stun 5", "Shark 10"],
  "Main Stun": ["base", "backup", "North Chargers", "Pet 1/3", "Pet 2", "learner", "North Tank", "Jelly Wrangler", "Stun 5", "Shark 10"],
  
  "North Tank": ["base", "backup", "North Chargers", "Pet 1/3", "Pet 2", "learner", "CPR", "Main Stun", "Poison Tanks"],
  "Jelly Wrangler": ["base", "backup", "North Chargers", "Pet 1/3", "Pet 2", "learner", "CPR", "Main Stun", "Poison Tanks"],
  'Stun 5': ["base", "backup", "North Chargers", "Pet 1/3", "Pet 2", "learner", "CPR", "Main Stun", "Poison Tanks"],
  "Shark 10": ["base", "backup", "North Chargers", "Pet 1/3", "Pet 2", "learner", "CPR", "Main Stun", "Poison Tanks"],
  
  "Learner": ["base", "backup", "North Chargers", "Pet 1/3", "Pet 2", "free", "Base (Yaka)", "CPR", "Poison Tanks", "North Tank", "Jelly Wrangler", "Main Stun", "Stun 5", "Shark 10"],
};

// Boss == value set in builder with the first letter capitalized, keep it lowercase in value
function createFullRaidPoisonEmbed(user, field = {}) {
  // Create the embed
  const embed = new EmbedBuilder()
    ...
    .addFields(
      ...
      {
        name: "<:Poison:1288127146782363690> Poison Tanks",
        value: field["Poison Tanks"] || "`Empty`\n`Empty`\n`Empty`\n`Empty`",
        inline: true,
      },
      {
...
module.exports = { createFullRaidPoisonEmbed, combinabilityRules };